...
if __name__ == "__main__":
    ...
    if not (os.path.exists('./PyTorch/mnist/')
            ) or not os.listdir('./PyTorch/mnist/'):
    ...
    test_data = torchvision.datasets.MNIST(root="./PyTorch/mnist/",
                                           train=False)
            ...
            if step % 50 == 0:
                ...
                if HAS_SK:
                    ...
                    low_dim_embs = tsne.fit_transform(
                        last_layer.detach().numpy()[:plot_only, :])
